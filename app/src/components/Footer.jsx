...
export default function Footer() {
  return (
    ...
    <Link className="custom-logo-link" rel="home" to="/"><img loading="lazy" src="/wp-content/uploads/2025/09/logo.svg" className="custom-logo" alt="Alsinan Transport Dubai company logo" decoding="async" width="209" height="75" /></Link>
    </div>
    ...
    <ul>
    <li><a href="https://www.facebook.com/share/17Kka81PY8/?mibextid=wwXIfr" target="_blank"><img loading="lazy" src="/wp-content/uploads/2025/09/icon_fb.svg" alt="Alsinan Transport on Facebook" width="8" height="14" /></a></li>
    <li><a href="https://www.instagram.com/al_sinan_passengers_tranaport?igsh=MW4xaTU1NmFueHhibA%3D%3D&utm_source=qr" target="_blank"><img loading="lazy" src="/wp-content/uploads/2025/09/icon_insta.svg" alt="Alsinan Transport on Instagram" width="15" height="14" /></a></li>
