...
export default function SvcHotelTransportServiceInDubai() {
  ...
  return (
    <>
      ...
      <p>Guest transfers start from anywhere in Dubai. The areas we cover most often are:</p>
      </div>
      </div>
      ...
      <span className="sub_head">Hotel Transport</span>
      <h2>Arrange transport for your guests</h2>
      <p>Tell us the pickup schedule and how many guests you move in a typical week, and we will set up a standing arrangement.</p>
      </div>
      </div>
      </div>
      </div>
