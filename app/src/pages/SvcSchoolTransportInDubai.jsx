...
export default function SvcSchoolTransportInDubai() {
  ...
  return (
    <>
      ...
      <p>School routes run across Dubai. These are the areas we cover most often:</p>
      </div>
      </div>
      ...
      <span className="sub_head">School Transport</span>
      <h2>Tell us about your school run</h2>
      <p>Share the route, how many students travel and the pickup and drop timings, and we will come back with a plan for the term. Our buses run from 14 seaters up to 67 seater coaches.</p>
      </div>
      </div>
      </div>
      </div>
